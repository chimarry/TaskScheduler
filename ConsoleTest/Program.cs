    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void action3()
            {
                ...
                if (cooperationMechanism3.IsPaused)
                {
                    Console.WriteLine("Action 3 is paused");
                    Task.Delay(cooperationMechanism3.PausedFor).Wait();
                }
                cooperationMechanism3.CanBePaused = false;
                Thread.Sleep(1800);
                Console.WriteLine("Action 3 finished");
            }
            ...
            coreTaskScheduler.QueueForScheduling(new List<PrioritizedLimitedTask>()
              {
                  ...
                  new PrioritizedLimitedTask(action2, Priority.High, 3000)
                  {
                   ...
                   new PrioritizedLimitedTask(action3, Priority.Normal, 2020)
                   {
                       CooperationMechanism = cooperationMechanism3
                   }
              });
